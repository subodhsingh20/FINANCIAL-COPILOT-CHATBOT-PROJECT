...
const Login = () => {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(255,255,255,0.85),_transparent_28%),radial-gradient(circle_at_bottom_right,_rgba(125,211,252,0.35),_transparent_30%),linear-gradient(180deg,_#f7fafc_0%,_#eaf1ff_100%)] px-4 py-24 dark:bg-[radial-gradient(circle_at_top_left,_rgba(56,189,248,0.16),_transparent_24%),radial-gradient(circle_at_bottom_right,_rgba(249,115,22,0.12),_transparent_28%),linear-gradient(180deg,_#09090b_0%,_#111827_100%)]">
      ...
      <div className="relative grid w-full max-w-6xl overflow-hidden rounded-[36px] border border-white/60 bg-white/75 shadow-[0_40px_120px_-55px_rgba(15,23,42,0.35)] backdrop-blur-xl dark:border-white/10 dark:bg-white/5 dark:shadow-[0_40px_120px_-55px_rgba(0,0,0,0.65)] md:grid-cols-[1.05fr_0.95fr]">
        <section className="hidden flex-col justify-center bg-[linear-gradient(160deg,_rgba(255,255,255,0.92),_rgba(236,245,255,0.75))] p-10 md:flex dark:bg-[linear-gradient(160deg,_rgba(15,23,42,0.9),_rgba(17,24,39,0.8))]">
          <div>
            ...
            <p className="mt-5 max-w-lg text-base leading-8 text-slate-600 dark:text-slate-300">
              Continue your saved conversations, revisit ideas, and work with Gemini in a calm, professional interface.
            </p>
          </div>
        </section>
